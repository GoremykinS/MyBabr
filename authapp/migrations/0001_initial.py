    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_banned_time', models.DateTimeField(blank=True, null=True, verbose_name='Время начала блокировки')),
                ('stop_banned_time', models.DateTimeField(blank=True, null=True, verbose_name='Время окончания блокировки')),
                ('banned_time', models.IntegerField(default=0, verbose_name='Период блокировки')),
